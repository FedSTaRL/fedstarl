#
# Adjusted from https://github.com/apple/pfl-research/benchmarks/model/pytorch
# 
...
def image_classification_metrics(self: nn.Module,
    ...
    #loss_tensor = cross_entropy(self(inputs), targets, "mean")
    return {
        "loss": Weighted(loss.item(), num_samples),
        "accuracy": Weighted(correct, num_samples),
        "loss_tensor": loss / num_samples,
    }